...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="FedGen")  # 可以输入的是，FedAvg，FedProx，FedDistill，FedEnsemble，FedGen,FedDistillGen
    ...
    parser.add_argument("--temperature", type=int, default=1, help="distillation temperature")  # 蒸馏温度
