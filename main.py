...
def run_job(args, i):
    ...
    if args.train:
        ...
        server.test()
        print('final acc, glob_iter, loss: {:.5f},{}, {:.5f}'.format(server.append_acc_test_max, server.append_acc_test_iter, server.append_loss_min))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="FedDKDGen")
    ...
    parser.add_argument("--num_glob_iters", type=int, default=400)   # 训练的次数，外循环，在serverFedGen里面，应该是通信轮次
    ...
    parser.add_argument("--distillAlpha", type=int, default=2.0, help="the TCKD coefficient of DKD")  # DKD的alpha
    parser.add_argument("--distillBeta", type=int, default=1, help="the NCKD cofficient of DKD")  # DKD的beta
